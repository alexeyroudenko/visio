...
export const drawLinesNode = defineNode<LinesState>({
  ...
  label: "Draw Lines",
  category: "draw",
  description: "Отрезки из детекции линий, опционально с точками на концах.",
  inputs: [
  ...
  params: [
    { key: "color", label: "Цвет", type: "color", default: "#c39bff" },
    { key: "width", label: "Толщина", type: "range", min: 0.5, max: 20, step: 0.5, default: 2 },
    { key: "extend", label: "Удлинить ×", type: "range", min: 1, max: 3, step: 0.05, default: 1 },
    ...
    { key: "endpoints", label: "Точки на концах", type: "toggle", default: false },
    { key: "endpointSize", label: "Размер точек", type: "range", min: 1, max: 20, step: 0.5, default: 5 },
    BLEND_PARAM,
  ],
  createState() {
