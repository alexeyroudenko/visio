...
export const drawLandmarksNode = defineNode<DrawState>({
  ...
  label: "Draw Skeleton",
  category: "draw",
  description: "Рисует точки и кости из landmarks поверх входной текстуры.",
  inputs: [
  ...
  params: [
    { key: "pointColor", label: "Цвет точек", type: "color", default: "#f5f0e6" },
    { key: "boneColor", label: "Цвет костей", type: "color", default: "#7fe3c0" },
    { key: "pointSize", label: "Размер точек", type: "range", min: 0, max: 24, step: 0.5, default: 5 },
    { key: "boneWidth", label: "Толщина костей", type: "range", min: 0, max: 20, step: 0.5, default: 3 },
