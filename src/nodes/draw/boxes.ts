...
export const drawBoxesNode = defineNode<BoxesState>({
  ...
  label: "Draw Boxes",
  category: "draw",
  description: "Рамки детекций; опционально точка в центре каждой.",
  inputs: [
  ...
  params: [
    { key: "color", label: "Цвет", type: "color", default: "#ff5c7a" },
    { key: "width", label: "Толщина", type: "range", min: 0.5, max: 12, step: 0.5, default: 2 },
    ...
    { key: "centers", label: "Точка в центре", type: "toggle", default: true },
    { key: "centerSize", label: "Размер точки", type: "range", min: 1, max: 30, step: 1, default: 8 },
    BLEND_PARAM,
  ],
  createState() {
