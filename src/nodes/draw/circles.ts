...
export const drawCirclesNode = defineNode<CirclesState>({
  ...
  label: "Draw Circles",
  category: "draw",
  description: "Circles from detection: outline or fill; radius can be scaled.",
  inputs: [
  ...
  params: [
    { key: "color", label: "Color", type: "color", default: "#8fd6ff" },
    { key: "thickness", label: "Stroke", type: "range", min: 0.5, max: 20, step: 0.5, default: 2 },
    { key: "fill", label: "Fill", type: "toggle", default: false },
    { key: "radiusScale", label: "Radius ×", type: "range", min: 0.1, max: 3, step: 0.05, default: 1 },
