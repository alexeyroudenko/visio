...
export const drawPointsNode = defineNode<PointsState>({
  ...
  label: "Draw Points",
  category: "draw",
  description: "Облако точек: точка, кружок как в detection или перекрестье; плюс паутина связей.",
  inputs: [
  ...
  params: [
    {
      ...
      options: [
        ...
        { value: "circle", label: "кружок (detection)" },
        { value: "cross", label: "перекрестье" },
      ],
      default: "point",
    },
    { key: "color", label: "Цвет", type: "color", default: "#ffd166" },
    { key: "size", label: "Размер точки", type: "range", min: 0.5, max: 30, step: 0.5, default: 4 },
    { key: "sizeByScore", label: "Размер по score", type: "range", min: 0, max: 3, step: 0.1, default: 1 },
    { key: "minRadius", label: "Радиус мин.", type: "range", min: 2, max: 100, step: 1, default: 8 },
    { key: "maxRadius", label: "Радиус макс.", type: "range", min: 4, max: 200, step: 1, default: 34 },
    { key: "stroke", label: "Толщина обводки", type: "range", min: 0.5, max: 10, step: 0.5, default: 1.5 },
    { key: "centerDot", label: "Точка в центре", type: "toggle", default: true },
    { key: "opacity", label: "Прозрачность", type: "range", min: 0, max: 1, step: 0.05, default: 0.9 },
    { key: "linkRadius", label: "Радиус связей", type: "range", min: 0, max: 300, step: 5, default: 0 },
    { key: "linkWidth", label: "Толщина связей", type: "range", min: 0.5, max: 8, step: 0.5, default: 1 },
    BLEND_PARAM,
  ],
  createState() {
